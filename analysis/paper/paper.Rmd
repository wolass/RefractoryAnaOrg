...
`r elicitorTab[1,9]`% of food elicited refractory cases had a previously confirmed diagnosis of food allergy. Insect-venom and food allergens most frequently elicited severe cases of anaphylaxis.
...
Baseline serum tryptase (BST) levels were increased in patients with refractory anaphylaxis, although only in 7 patients it was over the threshold level of 11.5 ng/mL - what is commonly recognized as elevated [@klion2003]. BST may reflect pro-β tryptase due to increased body mast cell content [@CAUGHEY2006] or result from alpha-tryptasemia due to multiple copies of *TPSAB1* gene [@Lyons2018]. Irrespective of the mechanism - increased BST has been shown to correlate with the severity of anaphylaxis [@Aniceto2019]. 
